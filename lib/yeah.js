...
(function(name, myClass) {
     ...
     * @param {Number} scaleInverse Inversed scale
     * @param {Object} options Options of Yeah class
     */
    function fillTrackedPointsOnCanvas(canvasContext, trackedData, scaleInverse, options) {
    ...
    class Yeah {
        ...
        playVideo(src, delay) {
            ...
            .then(() => {
                ...
                this.scaleInverse = INVERSE_BASE / this.scale;
            ...
            this.captureIntervalTimer = setInterval(() => {
                ...
                .then((data) => pEmit(() => {
                    ...
                    if (!isVideoPaused(this.videoElm)) {
                        ...
                        fillTrackedPointsOnCanvas(this.userCtx, data, this.scaleInverse, this.options);
